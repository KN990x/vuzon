...
const ISSUE_MESSAGES = {
  ...
  'rule_name.invalid': 'the name must be text',
  'enabled.invalid': 'the enabled flag must be true or false',
  ...
  'password.unchanged': 'the new password must be different from the current one',
