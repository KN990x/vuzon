...
- **Environment variables:** do not rename or relocate established conventions (`VUZON_PORT`, `VUZON_DATA_DIR`, etc.) unless that is an explicit part of the change and covered by tests and README updates where applicable.
